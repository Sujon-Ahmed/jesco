            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        @if (Auth::user()->photo == '')
                            <img src="{{ asset('backend_assets/img/avatar.png') }}" alt="Profile"
                                class="rounded-circle">
                        @else
                            <img src="{{ asset('backend_assets/uploads/users') }}/{{ Auth::user()->photo }}"
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'product.attributes' ? '' : 'collapsed' }}"
                    ...
                    <i class="bi bi-basket"></i><span>Product Attributes</span><i
