                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{ asset('frontend_assets/images/icons/payment.png') }}" alt="" class="payment-img img-fulid">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copy-text"> © <?= date('Y') ?> <strong>Jesco</strong> Develop <i class="fa fa-heart"
                                    aria-hidden="true"></i> By <a class="company-name" href="https://github.com/Sujon-Ahmed">
